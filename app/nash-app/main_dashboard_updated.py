"""
Nashville Transportation Incentive Simulation Dashboard - UPDATED WITH NASHVILLE SIMULATION TAB

A comprehensive Gradio-based interactive dashboard for visualizing traffic flow,
incentive effectiveness, behavioral calibration, simulation results, and Nashville
transportation patterns based on 2020 Census and ACS data.

To use this as your main dashboard:
1. Copy this file to your project root (or merge with existing main file)
2. Ensure nashville_sim_*.py files are in the same directory
3. Update imports in the 'components' section to match your actual module names
4. Run: python main_dashboard_updated.py
"""

import gradio as gr

# Existing component imports - MODIFY THESE TO MATCH YOUR PROJECT
...
# NEW IMPORTS for Nashville simulation - MAKE SURE THESE FILES ARE PRESENT
...
def create_app():
    ...
    with gr.Blocks(title="Nashville Incentive Simulation Dashboard") as app:
        gr.Markdown(
            ...
            Comprehensive analysis of traffic flow, incentive effectiveness, behavioral modeling,
            and transportation simulations for the Nashville-Davidson Metropolitan Area.
            """
        )
        ...
        with gr.Tabs():
            ...
            # This tab contains comprehensive analysis of Nashville MSA based on
            # 2020 Census DHC and ACS 2016-2020 commuting flow data
        ...
        gr.Markdown(
            ...
            - **I-24 MOTION Data**: LADDMS trajectories for real-time traffic analysis
            - **Rideshare Data**: Hytch trip data for incentive effectiveness
            - **Census Data**: 2020 Demographic and Housing Characteristics File (DHC)
            - **Commuting Data**: American Community Survey (ACS) 2016-2020 5-Year Estimates
            - **Employment Data**: Bureau of Labor Statistics and LODES
            
            Built with Python, Pandas, Matplotlib, Gradio, DuckDB, and dbt
            
            [GitHub Repository](https://github.com/LNshuti/ihute) | 
            [Documentation](https://github.com/LNshuti/ihute/wiki)
            """
        )
